...
conn = sqlite3.connect('data123.db')
c = conn.cursor()
...
def mainapp():
    ...
    <h3 style="color:black;font-family: 'Bree Serif';font-size:30px;">Output Image:</h3>
        ...
        <link href='https://fonts.googleapis.com/css?family=Bigshot One' rel='stylesheet'>
        <div>
    <h3 style="color:black;margin-bottom:-30px;font-family: 'Bigshot One';font-size:30px;">Have You Registered?<span style='font-size:30px;'>&#129300;</span></h3> </div><br>
        """
